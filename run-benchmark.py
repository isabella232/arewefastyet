...
def tasks():
   ...
   os.system('python3.7 initialize_benchmark.py '+ str(run_id) + ' ' + commit)
   ...
   os.system('python3.7 report.py ' + str(run_id) + ' ' + source + ' oltp')
   ...
   os.system('python3.7 report.py ' + str(run_id) + ' ' + source + ' tpcc')
